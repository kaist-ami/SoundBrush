...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        "--logdir",
        type=str,
        default="/local_data/sung/Instructpix2pix/logs",
...
if __name__ == "__main__":
    ...
    try:
        ...
        # model
        model = instantiate_from_config(config.model)
        # ckpt = "/local_data/sung/Instructpix2pix/logs/train_sb_v2_0801_2stages/checkpoints/last.ckpt"
        # model = load_model_from_config(config, ckpt, None)
